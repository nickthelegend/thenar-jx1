...
ACT = {
    "L": {"D": 0.100, "L_HOUSING": 0.052, "T_OUT": 0.006, "D_OUT": 0.064, "PILOT_D": 0.040, "PILOT_H": 0.002,
          "PCD_OUT": 0.052, "N_OUT": 8, "HOLE_OUT": 0.0033, "PCD_REAR": 0.084, "N_REAR": 8, "HOLE_REAR": 0.0033,
          "BOLT": "M4", "CONN": (0.024, 0.010, 0.018)},
    "M": {"D": 0.080, "L_HOUSING": 0.043, "T_OUT": 0.005, "D_OUT": 0.052, "PILOT_D": 0.030, "PILOT_H": 0.002,
          "PCD_OUT": 0.042, "N_OUT": 6, "HOLE_OUT": 0.0025, "PCD_REAR": 0.068, "N_REAR": 6, "HOLE_REAR": 0.0025,
          "BOLT": "M3", "CONN": (0.020, 0.009, 0.016)},
}
...
PKG = {
    ...
    "ankle_A_z": -0.100,         # ankle motor A axis below the knee axis (upper motor, output lateral +Y)
    "ankle_B_z": -0.190,         # ankle motor B axis below the knee axis (lower motor, output medial -Y)
}
