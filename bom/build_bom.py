...
add("Manufacturing", "PA-CF filament", "eSUN PA-CF 1.75 mm 1 kg", "torso frame, arm links, covers (legs/pelvis moved to aluminium after FEA)", 3, "3Idea", "https://www.3idea.in/product-detail/esun-pa-cf-3d-printing-filament-black-1-75mm-net-weight-1kg", 4799, "listed price", "In stock", 1.0, "Numakers PETG-CF (≈₹1,356/kg incl.)", 1356, "stiffness/heat resistance; ~2.5 kg of prints (torso 1.5, arms 1.0) + 20 % waste; printed-part rows carry print time only")
